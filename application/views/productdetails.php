...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>"> <img style="width:29%" src="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>" alt=""/></a>
                   <a href="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>"> <img style="width:29%" src="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>" alt=""/></a>
                   <a href="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>" > <img style="width:29%" src="<?php echo base_url();?><?php echo $pdetail[0]->pro_image;?>" alt=""/></a>
                  </div>
                  <div class="item">
			...
			<div class="span6">
				<h3><?php echo $pdetail[0]->pro_name;?></h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><?php echo $pdetail[0]->pro_price;?>/-</span></label>
					<div class="controls">
