...
<body class="animsition">
             ...
             ?>
                            <form action="<?php echo base_url('Login/index');?>" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="uname" placeholder="username" value="<?php echo set_value('uname');?>">
                                    <span class="text-danger"><?php echo form_error('uname');?></span>
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" name="pass" placeholder="Password" value="<?php echo set_value('pass');?>">
    ...
    <!-- Jquery JS-->
    <script src="<?php echo base_url();?>assets/themes/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap JS-->
